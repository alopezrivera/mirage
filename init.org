...
(defun custom/org-return ()
  ...
  (interactive)
  (cond ((custom/org-relative-line-list-empty)        (progn (org-return) (move-beginning-of-line nil)))
	      ((custom/org-relative-line-list)              (progn (org-return) (org-cycle)))
...
(defun custom/org-metaright (orig-fun &rest args)
  (if (and (not (custom/org-relative-line-list)) (custom/org-relative-line-list -1))
      (progn
	      (end-of-line 0)
	      (custom/org-return)
...
(defun custom/org-meta-return ()
  ...
  (cond ((custom/org-relative-line-list-empty) (progn (org-meta-return) (next-line) (end-of-line)))
	      ((custom/org-relative-line-heading)    (custom/org-insert-heading-respect-content))
