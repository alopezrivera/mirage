...
** Shell
:PROPERTIES:
:header-args:emacs-lisp: :tangle ./outfits/shapes-shell.el
:END:
...
** Display
:PROPERTIES:
:header-args:emacs-lisp: :tangle ./extensions/shapes-display.el
:END:
*** Window
**** Resize
***** window-resize
...
** Programming
:PROPERTIES:
:header-args:emacs-lisp: :tangle ./extensions/shapes-programming.el
:END:
*** Folding
**** TODO Cycle
