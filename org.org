...
(defface custom/marker-typeface
  '((nil :inherit 'fixed-pitch))
  "List marker typeface")

(font-lock-add-keywords
 'org-mode
 '(("^[[:blank:]]*[0-9]+[.\\)]\\{1\\}[[:blank:]]\\{1\\}" 0 'custom/typeface-marker))
 'append)

(font-lock-add-keywords
 'org-mode
 '(("^[[:blank:]]*[.+]\\{1\\}[[:blank:]]\\{1\\}" 0 'custom/typeface-marker))
 'append)
...
(defface custom/typeface-indent-paragraph
  '((nil :inherit 'fixed-pitch :invisible t))
  "Face for bluuet of plain list")

(font-lock-add-keywords
 'org-mode
 '(("^[[:blank:]]+" 0 'custom/typeface-indent-paragraph))
 'append)
